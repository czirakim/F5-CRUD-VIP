...
def modify_profile():
    ...
    for item in items:
        ...
        for profile in profiles:
            ...
            try:
                response = requests.request("PUT", f"{base_url}{type}/{profile['name']}", headers=headers, data=payload, verify=False)
                ...
                logger.info(f"Profile {profile['name']} has been modified. ")
